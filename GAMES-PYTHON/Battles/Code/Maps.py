...
size = star1.get_size()
star01 = pygame.transform.scale(star1, (int(size[0]/5), int(size[1]/5)))

star2 = pygame.image.load("Images/2-stars.png")
size = star2.get_size()
star02 = pygame.transform.scale(star2, (int(size[0]/5), int(size[1]/5)))

star3 = pygame.image.load("Images/3-stars.png")
size = star3.get_size()
star03 = pygame.transform.scale(star3, (int(size[0]/5), int(size[1]/5)))
